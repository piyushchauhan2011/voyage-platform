 ...
 * The compiler generates constructor, getters, equals, hashCode, and toString automatically.
 *
 * Equivalent verbose class would be ~40 lines. Records eliminate that boilerplate.
 */
