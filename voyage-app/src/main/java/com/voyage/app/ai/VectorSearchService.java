 ...
 *
 * Splitting these apart matters: search on its own shows you exactly which documents were
...
public class VectorSearchService {
     ...
     *
     * The optional filter expression is where metadata earns its place: it is applied as a real
     ...
     *
     * The retrieved documents are pulled back out of the advisor's response context so the answer
     * can be checked against its own sources — the practical defence against a confident hallucination.
     */
