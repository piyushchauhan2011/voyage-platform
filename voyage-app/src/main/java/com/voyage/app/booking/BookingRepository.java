...
public interface BookingRepository extends JpaRepository<Booking, Long>, JpaSpecificationExecutor<Booking> {
    ...
    @Query("""
            ...
            order by booking.checkIn asc
            """)
    List<Booking> findByHotelAndStatus(@Param("hotelId") Long hotelId, @Param("status") BookingStatus status);
    ...
    @Query("""
            ...
            """)
    long countByHotelAndDateRange(@Param("hotelId") Long hotelId,
