...
public interface RoomInventoryRepository
    extends JpaRepository<RoomInventory, Long>, JpaSpecificationExecutor<RoomInventory> {

  Optional<RoomInventory> findByHotelIdAndDateAndRoomType(
      Long hotelId, LocalDate date, RoomType roomType);
  ...
  @Query(
      """
            ...
            """)
  Optional<RoomInventory> findForUpdate(
  ...
  @Query(
      """
            ...
            """)
  List<RoomInventory> findInventoryWindow(
      @Param("hotelId") Long hotelId,
