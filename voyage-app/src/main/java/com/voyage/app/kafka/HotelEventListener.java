...
public class HotelEventListener {
  ...
  public HotelEventListener(
      HotelEventStatusService hotelEventStatusService, ObjectMapper objectMapper) {
  ...
  public void consume(
    ...
    try {
      ...
      hotelEventStatusService.recordProcessedEvent(
          event, topicName, partitionId, kafkaOffset, messageKey);
