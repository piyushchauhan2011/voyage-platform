...
public class HotelEventPublisher {
    ...
    public HotelEventPublisher(KafkaTemplate<String, String> kafkaTemplate,
                               Clock clock,
    ...
    public void publish(HotelEventType eventType, Hotel hotel) {
        ...
        try {
            kafkaTemplate.send(hotelEventsTopic, hotel.getId().toString(), objectMapper.writeValueAsString(event));
