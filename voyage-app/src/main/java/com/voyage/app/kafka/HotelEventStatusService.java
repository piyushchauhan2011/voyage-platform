...
public class HotelEventStatusService {
  ...
  public HotelEventStatusService(
      ProcessedHotelEventRepository processedHotelEventRepository,
  ...
  public void recordProcessedEvent(
      HotelEvent event, String topicName, int partitionId, long kafkaOffset, String messageKey) {
    ...
    try {
      ...
      // Duplicate delivery is acceptable in at-least-once systems; the unique event id keeps
      // storage idempotent.
    }
  }
