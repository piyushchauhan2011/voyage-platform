...
public class PaymentService {
    ...
    public PaymentService(PaymentRepository paymentRepository, HotelAccessService hotelAccessService) {
    ...
    private Payment applyRefund(Payment payment) {
        ...
        if (payment.getStatus() != PaymentStatus.SUCCEEDED) {
            throw new ConflictException("Only SUCCEEDED payments can be refunded (status=" + payment.getStatus() + ")");
        }
