...
public class RedisPlaygroundController {
  ...
  public RedisStringValue putString(
      @PathVariable String key, @RequestBody RedisStringWriteRequest request) {
  ...
  public RedisHashValue putHash(
      @PathVariable String key, @RequestBody RedisHashWriteRequest request) {
  ...
  public RedisListValue putList(
      @PathVariable String key, @RequestBody RedisCollectionWriteRequest request) {
  ...
  public RedisSortedSetValue putSortedSet(
      @PathVariable String key, @RequestBody RedisSortedSetWriteRequest request) {
  ...
  public RedisLockValue acquireLock(
      @PathVariable String lockName, @RequestBody RedisLockAcquireRequest request) {
    return redisPlaygroundService.acquireLock(lockName, request.owner(), request.ttlSeconds());
  }

  @DeleteMapping("/locks/{lockName}")
  public RedisLockReleaseResult releaseLock(
      @PathVariable String lockName, @RequestParam String owner) {
