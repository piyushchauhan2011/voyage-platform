 ...
 *
 * <p>401 Unauthorized — no valid credentials were provided (missing or invalid token) 403 Forbidden
 * — credentials are valid but the role doesn't permit access → AccessDeniedHandlerImpl
 */
@Component
