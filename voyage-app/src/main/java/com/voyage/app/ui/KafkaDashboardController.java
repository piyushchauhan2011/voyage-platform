...
public class KafkaDashboardController {
  ...
  public String dashboard(Model model) {
    ...
    model.addAttribute(
        "recentDeadLetters", toDeadLetterView(deadLetterHotelEventService.getRecentDeadLetters()));
  ...
  public String history(Model model) {
    ...
    model.addAttribute(
        "deadLetterHistory", toDeadLetterView(deadLetterHotelEventService.getDeadLetterHistory()));
        ...
        .map(
            event ->
                new DeadLetterEventView(
                    ...
                    event.getOriginalEventType() != null
                        ? event.getOriginalEventType().name()
                        : null,
