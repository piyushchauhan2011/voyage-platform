...
class TransactionPolicyTest {
  ...
  void bookingCreationUsesRepeatableReadAndRollbackRule() throws Exception {
    Method method =
        BookingService.class.getMethod("createBooking", String.class, CreateBookingRequest.class);
    ...
    assertArrayEquals(
        new Class[] {com.voyage.app.exception.PaymentFailedException.class},
  ...
  void paymentAndNotificationUseDifferentPropagationModes() throws Exception {
    Method paymentMethod =
        PaymentService.class.getMethod(
            "charge", com.voyage.app.booking.Booking.class, String.class);
    Transactional paymentTx = paymentMethod.getAnnotation(Transactional.class);
    Method writerMethod =
        NotificationWriter.class.getMethod("writeBookingConfirmed", BookingConfirmedEvent.class);
    Transactional writerTx = writerMethod.getAnnotation(Transactional.class);
    Method notificationMethod =
        NotificationService.class.getMethod("onBookingConfirmed", BookingConfirmedEvent.class);
