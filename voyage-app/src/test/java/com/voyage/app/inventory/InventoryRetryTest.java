...
class InventoryRetryTest {
    ...
    void reserveRoom_retriesOnLockFailure() {
        ...
        assertDoesNotThrow(() -> inventoryService.reserveRoom(42L, RoomType.SUITE, LocalDate.of(2030, 1, 10)));
        verify(roomInventoryRepository, times(2)).findForUpdate(42L, LocalDate.of(2030, 1, 10), RoomType.SUITE);
    }
}